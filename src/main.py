...
config = {
  ...
  "available_awb": ['auto', 'off', 'sunlight', 'cloudy', 'shade', 'tungsten', 'fluorescent', 'incandescent', 'flash', 'horizon'],
  "awb": 'auto',
  "default_awb": 'auto', # "awb_gains": 0.0 - 8.0 (),
  "available_menu_items": ["auto", "exposure_mode", "iso", "shutter_speed", "AWB", "hdr", "video", "resolution", "encoding"],
  "menu_item": "auto",
